...
import 'package:socialapp/screens/OtherPages/friendsprofile/friendsprofile.dart';
  ...
  Widget buildSerchField() {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: Colors.black.withOpacity(0.29), blurRadius: 4)
          ]),
      child: TextFormField(
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Image.asset(
                                    'lib/assets/icons/addfriend.png',
                                    width: 30,
                                    height: 30,
                                  )
                                ],
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: Text(
                                      ...
                                      style:
                                          textArialRegularSecondarysmwithop(),
                                    ),
                                  ),
                                  Image.asset(
                                    'lib/assets/icons/addfriend.png',
