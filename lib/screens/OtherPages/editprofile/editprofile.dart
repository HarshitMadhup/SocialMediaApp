  ...
  Widget buildprofilenametextfield() {
    return Padding(
      ...
      child: Container(
        height: 50,
        decoration: BoxDecoration(
            color: Color(0xFFF6F9FD), borderRadius: BorderRadius.circular(10)),
        child: TextFormField(
      ...
      child: GFTypography(
        ...
        child: RichText(
          text: TextSpan(
            children: <TextSpan>[
              TextSpan(
                  text: "Place", style: textArialRegularsecondarysmwithop()),
            ],
          ),
        ),
      ),
      ...
      child: GFTypography(
        ...
        child: RichText(
          text: TextSpan(
            children: <TextSpan>[
              TextSpan(
                  text: "Email Id", style: textArialRegularsecondarysmwithop()),
            ],
          ),
        ),
      ),
