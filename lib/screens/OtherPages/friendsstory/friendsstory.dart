        ...
        children: <Widget>[
          StoryView(
            [
              ...
              StoryItem.pageImage(AssetImage("lib/assets/images/story.png"),
                  imageFit: BoxFit.cover
                  // caption: "Still sampling",
                  ),
              // StoryItem.pageGif(
          ...
          Positioned(
              ...
              child: Container(
                ...
                height: 88,
                decoration:
                    BoxDecoration(color: Colors.black.withOpacity(0.50)),
                child: Row(
                  children: <Widget>[
                    Container(
                      width: 30,
    ...
    return Stack(
      children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(
              image: DecorationImage(
                  image: AssetImage('lib/assets/images/story.png'),
                  fit: BoxFit.cover)),
        ),
      ],
    );
