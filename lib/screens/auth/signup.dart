...
import 'package:socialapp/screens/auth/login.dart';
...
class _SignUpState extends State<SignUp> {
  ...
  Widget buildwelcometext() {
    return Center(
      child: Column(
        children: <Widget>[
          //  SvgPicture.asset('lib/assets/icons/logo.svg',width: 75,height: 75,),
          Image.asset(
      ...
      child: GFTypography(
        ...
        child: RichText(
          text: TextSpan(
            children: <TextSpan>[
              TextSpan(
                  text: "Confirm Password", style: textArialRegularWhite()),
              TextSpan(
                text: ' *',
                style: TextStyle(color: Color(0xFFFFFFFF)),
              ),
